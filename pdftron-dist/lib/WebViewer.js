...
(function($) {
    ...
    PDFTron.WebViewer.prototype = {
        ...
        _createViewer: function(viewers) {
            ...
            if (PDFTron.WebViewer.isMobileDevice()) {
        ...
        _createHTML5Mobile: function() {
            ...
            var width = this.element.offsetWidth + 'px';
            var height = this.element.offsetHeight + 'px';
    ...
    PDFTron.WebViewer.isMobileDevice = function() {
        return ((navigator.userAgent.match(/Edge/i) && PDFTron.WebViewer.scrollbarWidth() === 0) ||
    ...
    PDFTron.WebViewer.scrollbarWidth = function() {
